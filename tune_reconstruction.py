...
def build_reference(base_dir: Path, output_dir: Path, force: bool) -> tuple[Path, tuple[int, int], int]:
    ...
    grid = reconstruct_grid(patches, grid_shape, cfg)
    ...
    return reference_path, grid_shape, int(cfg.overlap_width or 0)
...
def tune(
    ...
    reference_path, grid_shape, overlap_width = build_reference(base_dir, output_dir, force=force)
