...
REPO_URL="https://github.com/Deepakmewadaa/Geospatial-Image-Stitching"
...
python -m pip install numpy Pillow pandas transformers accelerate huggingface_hub tokenizers
