...
from reconstruction_solver import estimate_overlap_width, estimate_grid_dimensions, load_patches, reconstruct_grid, stitch_map
...
def reconstruct_from_test_dir(test_dir: Path, output_map: Path, args: argparse.Namespace):
    ...
    print(f"[infer] {n} patches -> grid {n_rows}x{n_cols}")
